...
const SCENES = {
  ...
  lab_cure:        { img:'./images/lab_cure.png',          text:['The cure requires synthesizing your blood markers with compounds found in the field.', '"We have three location options for the final ingredients," the researcher says.', '"Military Hospital — high risk, high yield. The abandoned laboratory — safer but uncertain. The underground sewer — high risk, outcome unknown"'],                   b1:'Go to the Military Hospital', b2:'Go to the Abandoned Laboratory', b3:'Search the Underground Sewer', intel:'A researcher\'s notebook left open: "...compound reacts with GEN-type markers. Cross-ref: Project _SIS, classified above my clearance."' },
